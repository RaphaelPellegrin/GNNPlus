#!/usr/bin/env bash
# =============================================================================
# PATTERN paper repro v1: ta9qtxb9 anchor (a2g2, d_h=90, GCNE+RWSE) × seeds 0–4.
#
# Submit:
#   bash bash_interface/cluster/submit_pattern_hybrid_ta9qtxb9_paper_repro.sh
# =============================================================================

#SBATCH --job-name=pattern_paper_v1
#SBATCH --ntasks=1
...
wandb_name="pattern_hybrid_ta9qtxb9_a2g2_seed${seed}_job${job_tag}_${task_id}"

log_message "PATTERN v1 (ta9qtxb9) paper repro task ${task_id}/${num_seeds}: seed=${seed}"
