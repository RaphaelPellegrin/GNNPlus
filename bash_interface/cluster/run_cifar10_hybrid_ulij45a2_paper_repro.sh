#!/usr/bin/env bash
# =============================================================================
# CIFAR10 paper repro: ulij45a2 anchor (a8g4, d_h=256) × seeds 0–4.
#
# Submit:
#   bash bash_interface/cluster/submit_cifar10_hybrid_ulij45a2_paper_repro.sh
# =============================================================================

#SBATCH --job-name=cifar10_paper_v1
#SBATCH --ntasks=1
...
wandb_name="cifar10_hybrid_ulij45a2_a8g4_seed${seed}_job${job_tag}_${task_id}"

log_message "CIFAR10 paper repro task ${task_id}/${num_seeds}: seed=${seed}"
