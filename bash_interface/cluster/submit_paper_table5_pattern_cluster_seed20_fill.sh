...
# sbatch --export treats commas as delimiters; pass hyphens to worker nodes.
CLUSTER_VARIANT_INDICES_SLURM="$(echo "${CLUSTER_VARIANT_INDICES}" | tr ',;' '-')"
