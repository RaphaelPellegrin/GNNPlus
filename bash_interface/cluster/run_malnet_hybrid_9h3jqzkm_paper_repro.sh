#!/usr/bin/env bash
# =============================================================================
# MalNet-Tiny paper repro: 9h3jqzkm anchor (a0g2, d_h=110, GCNE) × seeds 0–4.
#
# Submit:
#   bash bash_interface/cluster/submit_malnet_hybrid_9h3jqzkm_paper_repro.sh
# =============================================================================

#SBATCH --job-name=malnet_paper_v1
#SBATCH --ntasks=1
...
wandb_name="malnet_hybrid_9h3jqzkm_a0g2_seed${seed}_job${job_tag}_${task_id}"

log_message "MalNet paper repro task ${task_id}/${num_seeds}: seed=${seed}"
