...
echo "  Time limit:   ${TIME} (1200 epochs; was 120h for 600 ep)"
...
echo "  W&B group:    paper_bestmodel_v2_peptides_func_zc371e1n_a0g1_ep1200"
...
echo "    --group paper_bestmodel_v2_peptides_func_zc371e1n_a0g1_ep1200"
echo ""
